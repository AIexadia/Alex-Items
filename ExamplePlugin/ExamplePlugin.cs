...
namespace ExamplePlugin
{
    ...
    public class ExamplePlugin : BaseUnityPlugin
    {
        ...
        public const string PluginAuthor = "Alexadia";
        public const string PluginName = "AlexItems";
        public const string PluginVersion = "0.0.1";

        //We need our item definition to persist through our functions, and therefore make it a class field.
        private static ItemDef alexItems;
        ...
        public void Awake()
        {
            ...
            alexItems = ScriptableObject.CreateInstance<ItemDef>();

            // Language Tokens, check AddTokens() below.
            alexItems.name = "EXAMPLE_CLOAKONKILL_NAME";
            alexItems.nameToken = "EXAMPLE_CLOAKONKILL_NAME";
            alexItems.pickupToken = "EXAMPLE_CLOAKONKILL_PICKUP";
            alexItems.descriptionToken = "EXAMPLE_CLOAKONKILL_DESC";
            alexItems.loreToken = "EXAMPLE_CLOAKONKILL_LORE";

            //The tier determines what rarity the item is:
            //Tier1=white, Tier2=green, Tier3=red, Lunar=Lunar, Boss=yellow,
            //and finally NoTier is generally used for helper items, like the tonic affliction
#pragma warning disable Publicizer001 // Accessing a member that was not originally public. Here we ignore this warning because with how this example is setup we are forced to do this
            alexItems._itemTierDef = Addressables.LoadAssetAsync<ItemTierDef>("RoR2/Base/Common/Tier2Def.asset").WaitForCompletion();
#pragma warning restore Publicizer001
            ...
            alexItems.pickupIconSprite = Resources.Load<Sprite>("Textures/MiscIcons/texMysteryIcon");
            alexItems.pickupModelPrefab = Resources.Load<GameObject>("Prefabs/PickupModels/PickupMystery");

            //Can remove determines if a shrine of order, or a printer can take this item, generally true, except for NoTier items.
            alexItems.canRemove = true;
            ...
            ItemAPI.Add(new CustomItem(alexItems, displayRules));
        ...
        private void GlobalEventManager_onCharacterDeathGlobal(DamageReport report)
        {
            ...
            if (attackerCharacterBody.inventory)
            {
                ...
                var garbCount = attackerCharacterBody.inventory.GetItemCount(alexItems.itemIndex);
                if (garbCount > 0 &&
        ...
        private void Update()
        {
            ...
            if (Input.GetKeyDown(KeyCode.F2))
            {
                ...
                PickupDropletController.CreatePickupDroplet(PickupCatalog.FindPickupIndex(alexItems.itemIndex), transform.position, transform.forward * 20f);
            }
        }
    }
}
